...
<head>
    ...
    <style>
        body { background: linear-gradient(135deg, #00b894 0%, #00cec9 100%); min-height: 100vh; }
        .login-card { max-width: 460px; margin: 70px auto; border-radius: 18px; box-shadow: 0 12px 42px rgba(0,0,0,0.22); overflow: hidden; }
        .login-header { background: linear-gradient(135deg, #00b894 0%, #00cec9 100%); color: white; padding: 34px 30px; text-align: center; }
        ...
        .btn-login { background: linear-gradient(135deg, #00b894 0%, #00cec9 100%); border: none; width: 100%; padding: 12px; font-size: 17px; color: #fff; border-radius: 10px; }
...
<div class="container">
    <div class="card login-card">
        <div class="login-header">
            ...
            <div class="login-subtitle">评委登录</div>
            <div class="mode-badge">仅评委账号可通过此入口登录</div>
        ...
        <div class="login-body">
            ...
            <form action="${pageContext.request.contextPath}/login" method="post">
                ...
                <button type="submit" class="btn btn-login">评委登录</button>
            </form>
        </div>
    </div>
</div>
