...
<head>
    ...
    <style>
        ...
        .page-header { background: linear-gradient(135deg, #667eea, #764ba2); color: white; padding: 32px 0; margin-bottom: 28px; }
        .card { border: 0; border-radius: 14px; box-shadow: 0 6px 18px rgba(0,0,0,.08); }
        .avatar-circle { width: 40px; height: 40px; border-radius: 50%; background: linear-gradient(135deg, #6C5CE7, #FD79A8); color: #fff; display: inline-flex; align-items: center; justify-content: center; font-weight: 700; font-size: 16px; }
