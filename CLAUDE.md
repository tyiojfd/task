...
- [x] Session管理和退出登录
- [x] 管理员用户列表查询（UserManageServlet ✅ 2026-07-08）
- [x] 用户搜索/筛选（模糊搜索 ✅ 2026-07-08）
- [x] 用户启用/禁用管理（status切换 ✅ 2026-07-08）
- [x] 用户角色管理（模态框分配 ✅ 2026-07-08）
- [x] 管理员重置用户密码（模态框 ✅ 2026-07-08）
- [x] 找回密码功能（ForgotPasswordServlet ✅ 2026-07-08）
- [x] XSS防护收尾（c:out替换 ✅ 2026-07-08）
